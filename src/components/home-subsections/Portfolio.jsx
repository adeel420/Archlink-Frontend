    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
        {portfolioData.slice(0, 4).map((data, index) => (
          <div
            className="flex flex-col  p-6 rounded-xl border border-gray-200 transition-transform duration-300 hover:scale-105 hover:shadow-lg bg-white"
            key={index}
          >
            <div className="bg-[#dddddd] w-full h-[150px] rounded "></div>
